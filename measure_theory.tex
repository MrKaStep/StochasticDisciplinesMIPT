...
\begin{document}
  ...
  \section{Дискретное вероятностное пространство. Классическая вероятность. Построение простейших вероятностных пространств. Элементы комбинаторики. Вероятность суммы событий.}
	...
	\begin{proof}
		...
		Последнее равенство следует из конечности $ g \circ f $\footnote{Поскольку непрерывная на $ G $ функция $ g $ не может принимать бесконечных значений в конечных точках из $ G $, а $ f $ принимает только конечные значения по условию.}, принадлежность $ \Sigma $ — из теоремы 15.1.
	\end{proof}
